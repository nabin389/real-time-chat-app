  ...
  return (
    ...
    <>
    {
      selectedUser ? (
        ...
        // new taking this new
        <div className="w-1/2 lg:w-2/3 flex flex-col not-only:">

{/* // this is movine with parent this is header div */}
      ...
      {/* till here header div  */}
      <Messages />
        <SendInput/>
    </div>

      ):(
        <div className="w-1/2 lg:w-2/3 flex flex-col justify-center text-center">
          <div>
